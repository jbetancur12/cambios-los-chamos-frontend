...
export function GirosPage() {
  ...
  const queryParams = {
    ...
    transferencistaId:
      filterUserType === 'TRANSFERENCISTA' && selectedTransferencistaId !== 'ALL'
        ? selectedTransferencistaId
        : undefined,
  }
  ...
  const { data: totalsData } = useGirosTotals(queryParams)
    ...
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      {(user?.role === 'ADMIN' || user?.role === 'SUPER_ADMIN' || user?.role === 'TRANSFERENCISTA') && (
        <div className="relative mb-6">
          ...
          <Input
            placeholder="Buscar por minorista..."
      ...
      {isLoading ? (
        ...
        <>
          ...
          >
            ...
            {/* Additional info */}
            {/* Additional info when viewing completed or all giros - only for Admin/SuperAdmin */}
