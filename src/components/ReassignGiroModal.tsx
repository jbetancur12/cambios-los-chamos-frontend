...
export function ReassignGiroModal({ giro, open, onOpenChange, onSuccess }: ReassignGiroModalProps) {
  ...
  const availableTransferencistas = transferencistas.filter(
    (t) => t.transferencistaId && t.transferencistaId !== giro?.transferencista?.id && t.available !== false
  )
        ...
        <SheetBody>
          ...
          <div className="py-2 space-y-4">
            <div className="space-y-2">
              ...
              {isLoading ? (
                ...
                <p className="text-sm text-red-600">No hay otros transferencistas disponibles.</p>
              ) : (
                <Select
          ...
          <div className="flex gap-2 pt-4 border-t mt-6">
            ...
            <Button
              ...
              disabled={!selectedTransferencistaId || isSubmitting || !hasAvailable}
              className="flex-1"
            >
